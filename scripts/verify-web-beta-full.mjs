...
const verificationCommands = [
  ...
  {
    id: "verify-cloud-manifest-request",
    command: "npm run verify:cloud-manifest-request",
    args: ["run", "verify:cloud-manifest-request"],
    purpose:
  ...
  {
    id: "verify-cloud-manifest-handshake",
    command: "npm run verify:cloud-manifest-handshake",
    args: ["run", "verify:cloud-manifest-handshake"],
    purpose:
