...
> = [
  {
    ...
    relation_goal: "把公司主页、投资备忘录、业绩复盘、估值假设和关键指标连接到报告与会议。",
    row_usage: "适合在公司跟踪表中创建公司级研究资产行，后续补公司页面、关联报告和关联会议关系。",
  ...
  },
  {
    ...
    relation_goal: "把会议纪要、转录稿和行动项连接到公司、报告和后续研究动作。",
    row_usage: "适合在会议跟踪表中创建会议资产行，后续补会议纪要、转录稿页面、行动项、公司页面和关联报告。",
