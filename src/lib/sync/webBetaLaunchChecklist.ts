  ...
  return [
    ...
    },
    {
      ...
      evidence: input.conflictReview
        ? `Conflict scaffold covers ${input.conflictReview.summary.surfaces} surfaces, and sync UI includes local-only side-by-side, baseline request, staging, schema/cursor proof, disposable replay/RLS proof contracts, disposable replay confirmation receipt, and empty-fixture replay package. It still does not read remote baselines.`
        : "No local conflict review scaffold is available.",
      required_action:
        "Export owner confirmation and empty-fixture package, run disposable replay/RLS proof on empty workspace fixtures, prove rollback, and require owner confirmation before multi-device editing.",
    },
    {
    ...
    },
    {
      ...
      required_action:
        "Make payload preview, replay receipts, and empty-fixture packages mandatory before cloud sync, disposable replay, AI execution, external asset loading, sharing, or bulk delete.",
    },
    {
