  ...
  return [
    {
      ...
      evidence:
        "Run lint, verify:web-beta, verify:replay-harness, and production build before any preview deployment is reviewed; replay harness verification also checks the disabled runner skeleton.",
      pass_condition:
