...
const FORMAT_ROUTES: PageImportFormatRoute[] = [
  ...
  },
  {
    ...
    preview_route: "editable-page-body",
    privacy_boundary:
      "DOCX/ODT 会在本地转换为可编辑页面；不上传文件内容。",
    execution_note: "确认后读取文档正文，把内容转换为可编辑页面正文。",
  },
  {
    id: "legacy-word-retain",
    label: "旧版 Word",
    extensions: [".doc"],
    lane: "local-retain",
    destination_module: "files",
    ...
    privacy_boundary:
      "旧版 .doc 不伪装成可编辑导入；先本地留存，建议转为 .docx 后再导入。",
    execution_note: "确认后创建本地文件页，只保留下载和复核入口。",
  },
  {
    ...
    preview_route: "editable-page-body",
    privacy_boundary:
      "PPTX/ODP 会在本地提取幻灯片文本并生成可编辑页面；不上传文件内容。",
    execution_note: "确认后读取幻灯片文本，把每页转换为可编辑页面章节。",
  },
  {
    id: "legacy-presentation-retain",
    label: "旧版 PowerPoint",
    extensions: [".ppt"],
    lane: "local-retain",
    destination_module: "files",
    ...
    preview_route: "local-metadata-review",
    privacy_boundary:
      "旧版 .ppt 不伪装成可编辑导入；先本地留存，建议转为 .pptx 后再导入。",
    execution_note: "确认后创建本地文件页，只保留下载和复核入口。",
  },
  {
    id: "epub-pages",
    ...
    preview_route: "editable-page-body",
    privacy_boundary:
      "EPUB 会在本地解析目录和章节并生成可编辑页面；不加载远程资源、不上传文件内容。",
    execution_note: "确认后读取 EPUB 包内章节，把正文转换为可编辑页面正文。",
  },
  {
    id: "rtf-pages",
    label: "RTF",
  ...
  },
  {
    ...
    preview_route: "editable-page-body",
    privacy_boundary:
      "Notebook 会在本地解析 markdown/code cells 并生成可编辑页面；只读取 JSON 文本，不执行代码。",
    execution_note:
      "确认后读取 notebook JSON，把单元格转换为可编辑页面正文；代码块保留为文本。",
  },
  {
    id: "archive-review",
    label: "ZIP",
