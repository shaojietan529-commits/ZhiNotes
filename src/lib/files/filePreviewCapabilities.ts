...
export const FILE_PREVIEW_CAPABILITIES: FilePreviewCapability[] = [
  ...
  {
    id: "markdown-note",
    label: "Markdown / MDX / R Markdown / Quarto",
    kinds: ["markdown"],
    extensions: [
      ".md",
      ".markdown",
  ...
  },
  {
    ...
    support_level: "converted",
    preview: "按需转换为表格 HTML 预览，最多显示前 5 个工作表。",
  ...
  },
  {
    ...
    support_level: "converted",
    preview: "按需转换预览；DOCX 使用 mammoth，ODT 读取 OpenDocument content.xml。",
    editable_import: "可导入为可编辑块。",
    database_import: "不适用。",
  ...
  },
  {
    ...
    support_level: "converted",
    preview: "按需转换预览；PPTX/ODP 提取幻灯片文本并生成本地 HTML。",
    editable_import: "可导入为可编辑块。",
    database_import: "不适用。",
  ...
  },
  {
    ...
    extensions: [".epub"],
    support_level: "converted",
    preview: "按需读取 EPUB spine 章节并生成本地 HTML 预览。",
    editable_import: "可导入为可编辑块。",
    database_import: "不适用。",
  ...
  },
  {
    ...
    preview: "按需列出压缩包内容、类型、压缩后大小和压缩方式。",
  ...
  },
  {
    ...
    support_level: "native",
    preview:
      "媒体使用浏览器原生预览；文本/代码/会议转录字幕/SEC XBRL/研究引用文件高亮；OPML 转大纲。",
    editable_import: "文本、代码、会议转录字幕、披露文本和 OPML 可导入为可编辑块。",
    database_import: "不适用。",
