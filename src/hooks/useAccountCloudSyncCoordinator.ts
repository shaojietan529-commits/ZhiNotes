  ...
  const localUseReadiness = useMemo(
    () =>
      buildAccountLocalUseReadiness({
        ...
        fileSyncEnabled: fileSync.status.enabled,
        settingsSyncEnabled: settingsSync.status.enabled,
        knowledgeSyncEnabled: knowledgeSync.status.enabled,
        portfolioSyncEnabled: portfolioSync.status.enabled,
    ...
    [
      ...
      globalSyncLogExtraPendingTotal,
      knowledgePendingTotal,
      knowledgeSync.status.enabled,
      manualReviewTotal,
      fileSync.status.enabled,
      pageSync.pendingStatus.enabled,
      pagePendingTotal,
      pendingTotal,
      portfolioPendingTotal,
      portfolioSync.status.enabled,
      portfolioSync.status.failed,
      portfolioSync.status.manualReviewCount,
      retryableFailedTotal,
      databaseSync.pendingStatus.enabled,
      settingsPendingTotal,
      settingsSync.status.enabled,
      state,
    ]
  );
